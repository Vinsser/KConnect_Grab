...
parser.add_argument('-R', '--restart_all', action='store_true', help='restart all failed tasks')
...
# method to restart all failed tasks
...
if __name__ == '__main__':
    ...
    elif (args.restart_all): restart_all_tasks()
